...
public interface TokenBaseMapper {
     ...
     * @mbg.generated
     */
    int deleteByPrimaryKey(@Param("userId") Integer userId, @Param("clientId") Integer clientId);
     ...
     * @mbg.generated
     */
    Token selectByPrimaryKey(@Param("userId") Integer userId, @Param("clientId") Integer clientId);
