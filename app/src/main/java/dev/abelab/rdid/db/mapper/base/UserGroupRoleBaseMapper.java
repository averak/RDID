...
public interface UserGroupRoleBaseMapper {
     ...
     * @mbg.generated
     */
    int deleteByPrimaryKey(@Param("groupId") Integer groupId, @Param("clientId") String clientId);
     ...
     * @mbg.generated
     */
    UserGroupRole selectByPrimaryKey(@Param("groupId") Integer groupId, @Param("clientId") String clientId);
